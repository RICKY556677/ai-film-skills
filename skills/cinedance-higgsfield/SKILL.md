...
description: >
  Convert scene ideas into production-ready English video prompts for Seedance
  2.0 and Higgsfield Seedance. Use for shot design, reference control, spatial
  blocking, first-frame occupancy, optics, camera movement, action timing,
  physics, lighting, dialogue, continuity, and prompt QA.
---
